...
exports.updateDeviceById = exports.getDevices = exports.getDeviceById = exports.deleteDeviceById = exports.createDevice = void 0;
...
var createDevice = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var _req$body, marca, modelo, imei, numero, ci, detalles, estado, newDevice, deviceSave;

    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _req$body = req.body, marca = _req$body.marca, modelo = _req$body.modelo, imei = _req$body.imei, numero = _req$body.numero, ci = _req$body.ci, detalles = _req$body.detalles, estado = _req$body.estado;
...
var getDevices = /*#__PURE__*/function () {
  ...
  return function getDevices(_x3, _x4) {
...
var getDeviceById = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.next = 2;
            return _Device["default"].findById(req.params.deviceId);
  ...
  return function getDeviceById(_x5, _x6) {
...
var updateDeviceById = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            _context4.next = 2;
            return _Device["default"].findByIdAndUpdate(req.params.deviceId, req.body, {
              "new": true
            });

          case 2:
            updatedDevice = _context4.sent;
  ...
  return function updateDeviceById(_x7, _x8) {
...
var deleteDeviceById = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            _context5.next = 3;
            return _Device["default"].findByIdAndDelete(deviceId);
  ...
  return function deleteDeviceById(_x9, _x10) {
