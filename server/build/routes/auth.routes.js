...
router.post('/signup', [_verifySignup.CheckDuplicatedUsernameOrEmail, _verifySignup.checkRolesExisted], authCtrl.signUp);
router.post('/signin', authCtrl.signin);
var _default = router; //posible falla aqui por los middlewwares
