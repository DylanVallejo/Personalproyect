      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            console.log(token); //if there is no token return an error 403 it means that 
          ...
          case 5:
            ...
            req.userId = decoded.id; //verifying if the user exist in the database
          ...
          case 9:
            user = _context.sent;
            console.log(user); //if there is not user return an error 400 it means a bad request
          ...
          case 13:
            console.log(decoded); // if user is found continue whit the process
        ...
        switch (_context2.prev = _context2.next) {
          ...
          case 14:
            ...
            return _context2.abrupt("return", res.status(403).json({
              message: "Only administrators can delete"
            }));
